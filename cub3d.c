...
/*   Updated: 2020/03/10 16:34:51 by grochefo         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int				main(int argc, char **argv)
{
	...
	data.list.east.width = 32;
	data.list.east.height = 32;
	data.list.west.width = 512;
	data.list.west.height = 512;
	if (argc == 2)
	{
		...
		data.list.east.id  = mlx_xpm_file_to_image(data.mlx, "wood.xpm", &data.list.east.height, &data.list.east.width);
		...
		data.list.west.id  = mlx_xpm_file_to_image(data.mlx, "rainbow.xpm", &data.list.west.height, &data.list.west.width);
